...
class PageController extends Controller
{
    ...
    public function postCheckout(Request $req){
        ...
        Session::forget('cart');
        return redirect()->back()->with('thongbao','Đặt hàng thành công!! Vui lòng chờ hệ thống xử lý!!');
    ...
    public function postLogin(Request $req){
        ...
        if($user){
            ...
            return redirect()->route('trang-chu')->with(['flag'=>'success','message'=>'Đăng nhập thành công']);
                ...
                return redirect()->back()->with(['flag'=>'danger','message'=>'Đăng nhập thất bại! vui lòng đăng nhập lại!!']);
            }
        }
        else{
