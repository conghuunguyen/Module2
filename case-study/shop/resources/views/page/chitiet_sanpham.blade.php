		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a class="btn btn-success" href="{{route('trang-chu')}}">Trang chủ</a> / <span>Thông tin chi tiết sản phẩm</span>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="single-item-options">
								...
								<input type="number" name="soluong" placeholder="nhập số lượng" min="0">
						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								<div class="media beta-sales-item">
									<a class="pull-left" href="route('chitietsanpham',$sptt->id)}}"><img src="source/assets/dest/images/products/sales/1.png" alt=""></a>
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="route('chitietsanpham',$sptt->id)}}"><img src="source/assets/dest/images/products/sales/2.png" alt=""></a>
									<div class="media-body">
										Sample Woman Top
										<span class="beta-sales-price">$34.55</span>
									</div>
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="route('chitietsanpham',$sptt->id)}}"><img src="source/assets/dest/images/products/sales/3.png" alt=""></a>
									<div class="media-body">
										Sample Woman Top
										<span class="beta-sales-price">$34.55</span>
									</div>
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="route('chitietsanpham',$sptt->id)}}"><img src="source/assets/dest/images/products/sales/4.png" alt=""></a>
									<div class="media-body">
										Sample Woman Top
										<span class="beta-sales-price">$34.55</span>
									</div>
